...
const Checkout = () => {
        ...
        <form onSubmit={handleSubmit} className='mt-3 '>
                ...
                <label>Name:</label>
                <input className='w-full ' name="name" type="text" value={formData.name} onChange={handleInputChange} />
            
          
                <label>Address:</label>
                <input className='w-full '  name="address" type="text" value={formData.address} onChange={handleInputChange} />
           
          
                <label>Credit Card:</label>
                <input className='w-full ' name="creditCard" type="text" value={formData.creditCard} onChange={handleInputChange} />
